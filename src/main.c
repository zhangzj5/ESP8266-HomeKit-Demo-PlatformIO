...
* esptool.py --baud 230400 -p /dev/cu.wchusbserialfd120 write_flash  -fm dio   -fs 32m  0x00000 .pioenvs/esp12e/eagle.flash.bin 0x14000 .pioenvs/esp12e/eagle.irom0text.bin
...
//use this block only once to set your favorite access point or put your own selection routine
        ...
        sprintf(sconfig->ssid, "4CE676AEAC85"); //don't forget to set this if you use it
        sprintf(sconfig->password, "zhang1978"); //don't forget to set this if you use it
